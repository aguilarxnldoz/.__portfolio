			...
			<div className="flex flex-col items-center md:items-start text-center md:text-left z-10">
				...
				>
					<p className="text-base md:text-lg text-dark/90 leading-relaxed">
						I am a 3rd year student in Computer Science with an unhealthy addiction to tech. Using modern technologies, I build, deploy, design, and scale applications and systems to industry standards.
					</p>
				</motion.div>
			</div>
		</motion.div>
