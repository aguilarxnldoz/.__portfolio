...
const projects = [
	{
		...
		images: [`${PROJECT_PATH}panday/panday_sample_1.png`, `${PROJECT_PATH}panday/panday_sample_2.png`, `${PROJECT_PATH}panday/panday_sample_3.png`, `${PROJECT_PATH}panday/panday_sample_4.png`],
