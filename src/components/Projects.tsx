...
const projects = [
	...
	},
	{
		...
		images: [
			`${PROJECT_PATH}circles/circles_sample_1.png`,
			`${PROJECT_PATH}circles/circles_sample_2.png`,
			`${PROJECT_PATH}circles/circles_sample_3.png`,
			`${PROJECT_PATH}circles/circles_sample_4.png`,
			`${PROJECT_PATH}circles/circles_sample_5.png`,
		],
