...
const floatConfigs = [
	...
	{y: [-7, 7], rotate: [-2, 2], duration: 2.3},
];

const techStack = [
	{src: "techstack-icons/vim-icon.svg", alt: "Vim", title: "Vim"},
	{src: "techstack-icons/nodejs-icon.svg", alt: "Node.js", title: "Node.js"},
	...
	{src: "techstack-icons/aws-icon.svg", alt: "Amazon Web Services", title: "AWS"},
	{src: "techstack-icons/jira-icon.svg", alt: "Atlassian Jira", title: "Jira"},
];

function TechStackItem({tech, index, isVisible}: {tech: (typeof techStack)[0]; index: number; isVisible: boolean}) {
	// Use modulo to cycle through animation configs if there are more techstacks than configs
	const entryDir = directions[index % directions.length];
...
export default function TechStackContainer() {
	...
	return (
		<div
			ref={containerRef}
			className="md:w-auto mx-auto p-3.5 mt-10 md:mt-20 xl:w-210"
		>
