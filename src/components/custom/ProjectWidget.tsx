...
export default function ProjectWidget({name, title = "Project", description = "Project details go here.", cancelLabel = "Close", url, github, images, isOpen, onClose, technologies, playUrl}: ProjectWidgetProps) {
				...
				<div className="mt-6">
					...
					>
						...
						{playUrl && (
							<iframe
								src={playUrl}
								className="w-full aspect-video rounded-lg border border-dark"
							></iframe>
						)}
					</div>
