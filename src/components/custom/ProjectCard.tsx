    ...
    return (
        <>
            ...
            >
                ...
                <div
                    className="absolute inset-0 bg-gradient-to-br from-crimson to-transparent transition-all duration-500 ease-out origin-top-left"
                    style={{
                ...
                <div
                    className="absolute inset-0 bg-gradient-to-tl from-dark to-transparent transition-all duration-500 ease-out origin-bottom-right"
                    style={{
                        transform: isHovered ? "scale(1)" : "scale(0)",
                        opacity: isHovered ? 1 : 0,
                    }}
